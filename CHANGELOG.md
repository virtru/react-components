...
## [v0.9.3](https://github.com/virtru/react-components/compare/v0.9.2...v0.9.3) - 2019-08-19
- NOREF ([#41](https://github.com/virtru/react-components/pull/41)) _patch_
  - Allow for enter button to select table rows
